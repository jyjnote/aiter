...
class CosyVoice2(CosyVoice):
    ...
    def inference_instruct2(self, tts_text, instruct_text, prompt_speech_16k, zero_shot_spk_id='', stream=False, speed=1.0, text_frontend=True, **kwargs): # [수정 1] **kwargs 추가
            ...
            for i in tqdm(self.frontend.text_normalize(tts_text, split=True, text_frontend=text_frontend)):
                ...
                # [수정 2] self.model.tts 호출 시 **kwargs를 전달
